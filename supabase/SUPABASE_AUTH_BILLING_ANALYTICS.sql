...
-- The QR Gate â€” Part 7: dashboard analytics upgrade.
--
-- Additive + idempotent. Runs on top of 0000 â†’ 0002. Everything here
...
--   â€¢ get_user_scan_overview()  â†’ account-wide UNIQUE visitors +
--     a richer "most scanned" (type / unique / last scanned).
--   â€¢ get_user_scan_activity(p_days) â†’ a daily scan/unique series for
--     the dashboard activity chart (7 / 30 / 90 / all-time).
--   â€¢ get_qr_scan_summary(p_qr_id, p_days) â†’ operating-system
--     breakdown + a privacy-safe "recent scans" feed (no IP, no
--     visitor hash â€” only coarse device/geo signals).
-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

-- â•â• 1. Account-wide overview (adds unique visitors + rich top QR) â•â•
create or replace function public.get_user_scan_overview()
returns jsonb
language plpgsql
security definer
...
-- â•â• 2. Daily activity series for the dashboard chart â•â•â•â•â•â•â•â•â•â•â•â•
...
-- â•â• 3. Per-QR summary â€” add OS breakdown + privacy-safe recent feed â•â•
...
-- â•â• 4. Grants â€” lock down, then hand execute to authenticated â•â•â•â•
revoke all on function public.get_user_scan_overview()          from public;
